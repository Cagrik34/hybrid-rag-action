...
**Last Execution:** `2026-09-10T07:16:46.211Z`  
...
|---|---|---|
| **Query Tokenization** | `0.00202` | ms |
| **BM25 Lexical Scorer** | `0.00626` | ms |
| **Dense Vector Scorer** | `0.01684` | ms |
| **RRF Rank Fusion (k=60)** | `0.00182` | ms |
| **V8 Heap Memory** | `4.66 MB / 6.6 MB` | MB |

## 🛡️ Retrieval Architecture Verification
- **AST Grounding:** `VERIFIED`
- **Reciprocal Rank Fusion Constant:** `k = 60`
- **SQLite FTS5 Compliant:** `COMPLIANT`
