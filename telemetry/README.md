...
**Last Execution:** `2026-09-22T07:40:45.379Z`  
...
|---|---|---|
| **Query Tokenization** | `0.00191` | ms |
| **BM25 Lexical Scorer** | `0.00734` | ms |
| **Dense Vector Scorer** | `0.01515` | ms |
| **RRF Rank Fusion (k=60)** | `0.00135` | ms |
| **V8 Heap Memory** | `4.73 MB / 6.6 MB` | MB |
