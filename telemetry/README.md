...
**Last Execution:** `2026-09-20T07:43:05.194Z`  
...
|---|---|---|
| **Query Tokenization** | `0.00218` | ms |
| **BM25 Lexical Scorer** | `0.00681` | ms |
| **Dense Vector Scorer** | `0.01779` | ms |
| **RRF Rank Fusion (k=60)** | `0.00186` | ms |
| **V8 Heap Memory** | `3.86 MB / 6.6 MB` | MB |
