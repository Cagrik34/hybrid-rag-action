...
**Last Execution:** `2026-09-21T07:56:06.393Z`  
...
|---|---|---|
| **Query Tokenization** | `0.002` | ms |
| **BM25 Lexical Scorer** | `0.00536` | ms |
| **Dense Vector Scorer** | `0.01449` | ms |
| **RRF Rank Fusion (k=60)** | `0.00157` | ms |
| **V8 Heap Memory** | `3.91 MB / 6.6 MB` | MB |
