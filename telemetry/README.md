...
**Last Execution:** `2026-09-14T07:52:11.790Z`  
...
|---|---|---|
| **Query Tokenization** | `0.00257` | ms |
| **BM25 Lexical Scorer** | `0.01108` | ms |
| **Dense Vector Scorer** | `0.01915` | ms |
| **RRF Rank Fusion (k=60)** | `0.00199` | ms |
| **V8 Heap Memory** | `3.98 MB / 6.6 MB` | MB |
